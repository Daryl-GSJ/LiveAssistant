...
## 10 分钟 Benchmark 决策轨迹

<div align="center">
  <img src="./docs/static/images/selective_decision_trajectory.png" alt="包含 60 个十秒片段的 10 分钟 Benchmark 案例" width="100%">
  <br><sub><b>一场完整直播，60 次因果决策。</b> 轨迹包含 19 次 benchmark emit 与 41 次 no-emit，并展示面向主播、面向观众以及主动保持沉默的代表性决策。</sub>
</div>

这张总览图将评测单元具体化：Live Assistant 评测的是**完整决策轨迹**，而不只是最终产生回复的片段。
